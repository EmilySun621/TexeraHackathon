/**
 * Scientific data analysis frameworks
 */

import type { ScientificFramework } from '../types/wizard';
...
export function getFrameworkPhases(framework: ScientificFramework): string[] {
  return FRAMEWORKS[framework].phases;
}
